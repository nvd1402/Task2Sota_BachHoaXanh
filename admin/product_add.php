...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Thêm sản phẩm
        $stmt = $conn->prepare("INSERT INTO products (name, slug, description, short_description, price, sale_price, price_min, price_max, weight_options, promo_heading, promo_content, sku, stock, category, brand_id, size_id, image, status, featured) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param(
          "ssssdddddssssiiiss",
          $name,
          $slug,
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="mb-3">
                      ...
                      <select name="size_id" class="form-control">
                        ...
                        <option value="<?= $size['id'] ?>" <?= (isset($_POST['size_id']) && $_POST['size_id'] == $size['id']) ? 'selected' : '' ?>>
