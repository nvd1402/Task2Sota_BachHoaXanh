...
$pageTitle = "Sửa sản phẩm - Admin Dashboard";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $checkStmt = $conn->prepare("SELECT id FROM products WHERE slug = ? AND id != ?");
        ...
        if ($stmt->execute()) {
            ...
            $errors[] = "Lỗi khi cập nhật sản phẩm: " . $stmt->error;
        }
        
        $stmt->close();
    }
    
    // Cập nhật $product với dữ liệu mới để hiển thị lại form
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <div class="mb-2">
                        <img src="../assets/images/<?= htmlspecialchars($product['image']) ?>" class="img-thumbnail" style="max-width: 200px;" alt="Ảnh hiện tại">
                      </div>
                      <?php endif; ?>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="sale_price" class="form-control" step="0.01" min="0" value="<?= htmlspecialchars($product['sale_price'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="stock" class="form-control" min="0" value="<?= htmlspecialchars($product['stock']) ?>">
                    </div>
